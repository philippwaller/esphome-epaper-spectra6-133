...
<!-- Don't update the ESPHome support snippets manually. Update requirements.txt and run scripts/esphome-versions.py sync. -->
<!-- x-esphome-version-specifier -->
[![ESPHome](https://img.shields.io/badge/ESPHome-%3E%3D%202025.11.0-000000?logo=esphome&logoColor=white)](https://esphome.io)
...
[Quick Start](#quick-start) · [Supported Panels](#supported-panels) · [Reference](#reference) · [How to use this component](#how-to-use-this-component) · [Image Preparation](#3-prepare-images-before-displaying-them) · [Examples](#example-configurations)
...
<!-- Don't update the ESPHome requirements block manually. Update requirements.txt and run scripts/esphome-versions.py sync. -->
...
|---|---|---|---|
| Goo Display ESP32-133C02 | ESP32-S3 | 16 MB | Revision 1.0, 2.0 |
